...
void tabjeu(SDL_Renderer *r){
    ...
    if(SDL_SetRenderDrawColor(r, 0, 0, 255, 255) != 0) SDL_ExitWithError("Rendu couleur");

    for (int i = 0; i < 450; i++)
    {
        SDL_RenderDrawLine(r, TMIN, i, 800, i);
    }
    

    if(SDL_SetRenderDrawColor(r, 139, 69, 19, 255) != 0) SDL_ExitWithError("Rendu couleur");
